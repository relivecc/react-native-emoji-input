...
const categoryIcon = {
    fue: props => (
        <Image
            style={props.tabSelected && { tintColor: "black" }}
            source={require("./assets/icons/emoji_icon_recent.png")}
        />
    ),
    people: props => (
        <Image
            style={props.tabSelected && { tintColor: "black" }}
            source={require("./assets/icons/emoji_icon_people.png")}
        />
    ),
    animals_and_nature: props => (
        <Image
            style={props.tabSelected && { tintColor: "black" }}
            source={require("./assets/icons/emoji_icon_nature.png")}
        />
    ),
    food_and_drink: props => (
        <Image
            style={props.tabSelected && { tintColor: "black" }}
            source={require("./assets/icons/emoji_icon_food.png")}
        />
    ),
    activity: props => (
        <Image
            style={props.tabSelected && { tintColor: "black" }}
            source={require("./assets/icons/emoji_icon_sport.png")}
        />
    ),
    travel_and_places: props => (
        <Image
            style={props.tabSelected && { tintColor: "black" }}
            source={require("./assets/icons/emoji_icon_travel.png")}
        />
    ),
    objects: props => (
        <Image
            style={props.tabSelected && { tintColor: "black" }}
            source={require("./assets/icons/emoji_icon_objects.png")}
        />
    ),
    symbols: props => (
        <Image
            style={props.tabSelected && { tintColor: "black" }}
            source={require("./assets/icons/emoji_icon_symbols.png")}
        />
    ),
    flags: props => (
        <Image
            style={props.tabSelected && { tintColor: "black" }}
            source={require("./assets/icons/emoji_icon_flags.png")}
        />
    ),
};
